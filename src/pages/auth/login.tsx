...
function AuthLogin() {
  ...
  const [forgotPassword] = useState(true);
    ...
    <>
      ...
      <div className="mx-auto w-full max-w-md space-y-6 ">
        ...
        <div className="text-center mt-5 text-sm">
          <p className="text-[#6B7280]">Don't have an account? <Link to="/auth/signup" className="text-[#9013fe]  no-underline font-medium hover:underline">Sign up</Link></p>
        </div>
      </div>
    </>
  );
